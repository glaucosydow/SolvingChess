...
let ``puzzle 11``() =
    ...
    let expected = [| R E1 E7; Q F6 E7; Q D5 C6; K C7 D8; Q C6 A8; K D8 D7; Q A8 C6 ; K D7 D8; Q C6 C8 |]
    let current = mateline.Value
...
let ``puzzle 12``() =
    let startpos = {
        EmptyBoard with
            WhiteKing = G1;
            WhiteQueens = H5;
            WhitePawns = B2 ||| E3 ||| F2 ||| G2 ||| H2;
            WhiteRooks = D4 ||| E6;
            WhiteBishops = C4

            BlackKing = H8;
            BlackQueens = C5
            BlackPawns = A7 ||| F5 ||| G7 ||| H7;
            BlackKnights = B4;
            BlackRooks = A8 ||| D8;
    ...
    let expected = [| Q H5 H7; K H8 H7; R D4 H4; K H7 G8; R E6 E8 |]
    let current = mateline.Value
...
let ``puzzle 14``() = 
    ...
    let expected = [| B B4 E1; R E2 E1; p G2 G3 |]
    let current = mateline.Value
